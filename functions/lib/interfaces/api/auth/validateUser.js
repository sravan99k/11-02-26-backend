...
const IAuthService = new FirebaseAuthService_1.FirebaseAuthService();
const useCase = new validateAndSyncUser_usecase_1.ValidateAndSyncUserUseCase(userRepo, IAuthService);
